...
// By ROOT version 5.34/01 on 2012-09-05 10:17:12
...
void Style_Example()
{
   ...
   delete gROOT->GetStyle("Example");

   TStyle *tmpStyle = new TStyle("Example", "Modern Style");
   ...
   tmpStyle->SetPadBottomMargin(0.14);
   tmpStyle->SetPadTopMargin(0.02);
   tmpStyle->SetPadLeftMargin(0.14);
   tmpStyle->SetPadRightMargin(0.04);
   ...
   tmpStyle->SetStatX(0.89);
   tmpStyle->SetStatY(0.88);
   ...
   tmpStyle->SetTitleFontSize(0.06);
   tmpStyle->SetTitleStyle(0);
   tmpStyle->SetTitleX(0.5);
   tmpStyle->SetTitleY(1);
